...
По окончании работы над каждой функцией не забудьте сделать соответствующие коммиты, как в примере с шифром Цезаря, а также коммит для объединения изменений с веткой `develop`.
...
При выполнении всех задач из лабораторной работы создайте новый релиз:
