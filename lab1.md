...
Ваша задача написать тело для следующих двух функций (шаблон файла можно найти тут):
...
Проверить работу программы можно с помощью доктестов (текст, который заключен в тройные кавычки и поход на работу с интепретатором в интерактивном режиме), которые приведены для каждой функции:
