...
<div class="alert alert-warning">
На текущий момент нам больше не нужно виртуальное окружение, так как эту часть функций, а именно изоляции окружения, на себя взял докер. Дополнительно можете посмотреть выступление Антона Егорова с Moscow Python: <a href="https://www.youtube.com/watch?v=X2jlKUHbepY">Докеризация приложений на Python</a>
</div>
