...
Далее представлен листинг, позволяющий создать игровое поле:
...
Класс `CellList` должен быть итерируемым (реализовывать iterator protocol). 
