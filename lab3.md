...
Помните, что вариантов значений для каждой позиции ровно **9**. 
...
Когда вы закончите работать над функцией `check_solution()`, запустите программу следующим образом:
